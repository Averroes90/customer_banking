...
def main():
    ...
    savings_interest = float(input('Please enter the savings APR in %: '))
    savings_maturity = int(input('Please enter how many months before maturity: '))
    ...
    print(f"Length of savings is: {savings_maturity} months.")
    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    # ADD YOUR CODE HERE
    cd_balance = float(input('Please enter your CD balance: '))
    cd_interest = float(input('Please enter your CD APR in %: '))
    cd_maturity = int(input('Please enter how many months before maturity: '))
